...
import me.Femhack.features.setting.EnumConverter;
import me.Femhack.features.setting.Setting;
import me.Femhack.Femhack;
import me.Femhack.event.events.PacketEvent;
import me.Femhack.event.events.ProcessRightClickBlockEvent;
...
public class OffhandPlus
    ...
    public OffhandPlus() {
        super("Offhand+", "Complicated offhand.", Module.Category.COMBAT, true, false, false);
        instance = this;
    }
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !Femhack.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
