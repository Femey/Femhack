...
import me.Femhack.features.modules.misc.AutoGG;
...
public class AutoCrystal
        extends Module {
    private final me.Femhack.util.Timer placeTimer = new me.Femhack.util.Timer();
    private final me.Femhack.util.Timer breakTimer = new me.Femhack.util.Timer();
    private final me.Femhack.util.Timer preditTimer = new me.Femhack.util.Timer();
    private final me.Femhack.util.Timer manualTimer = new Timer();
