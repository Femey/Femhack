...
import me.Femhack.mixin.mixins.accessors.IEntityRenderer;
...
public class Weather extends Module {
    ...
    private final Setting<Integer> height = this.register(new Setting<>("Height", 80, 0, 255));
    private final Setting<Float> strength = this.register(new Setting<>("Strength", 0.8f, 0.1f, 2.0f));
    public Setting<Boolean> snow = register(new Setting("Snow", Boolean.valueOf(true)));
    public Weather() {
        super("Weather", "Changes the weather", Category.RENDER, true, false, false);
    }
