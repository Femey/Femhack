...
public class InstantSpeed extends Module {
    ...
    public void listen(final MoveEvent event) {
        if (Anchor.AnchorING || this.mc.player.isSneaking() || this.mc.player.isInWater() || this.mc.player.isInLava() || mc.player.isElytraFlying() || mc.player.capabilities.isFlying) {
            return;
        }
